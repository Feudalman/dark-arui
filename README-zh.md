...
Dark-Arui 是一款专为长时间编码设计的暗色主题,采用统一的深黑背景营造出沉浸式的开发体验。新版语法高亮更偏轻松明亮：高频变量保持接近白色,关键词使用青色,字符串和注释采用绿色系,红色主要保留给错误和删除状态。
...
- **方法**: `#67d8ef` - 柔亮蓝青
- **数字/常量**: `#ffd166` - 明亮琥珀黄
- **类型/类/装饰器**: `#c792ea` - 紫罗兰,用于中频结构
- **对象 key/属性**: `#a7c7ff` - 柔亮蓝,和字符串绿区分
- **HTML/CSS 属性**: `#b7f774` - 浅青绿
- **参数**: `#b8dcae` - 更清晰的柔和绿
- **标签/Markdown 标题**: `#5ccfe6` - 柔和青色
- **运算符/语法符号**: `#8fb3c7` - 低刺激蓝灰
- **注释**: `#b8c8b880` - 半透明浅灰绿,低存在感但更易读

### 状态颜色

- **错误**: `#ff6b7a` - 柔和红,仅用于错误/删除
- **警告**: `#ffd166` - 琥珀黄
- **信息**: `#8aadff` - 蓝紫
